...
export const GuideIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v11.494m-5.75-8.494v5.494a.75.75 0 001.5 0V9.253m4.25-.5v8.494a.75.75 0 001.5 0V8.753m-10 1.5a.75.75 0 000 1.5h14.5a.75.75 0 000-1.5H3.75z" />
    </svg>
);
